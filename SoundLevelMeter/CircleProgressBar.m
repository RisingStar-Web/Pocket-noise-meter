...
#define DefaultHintBackgroundColor [UIColor colorWithWhite:1 alpha:1.0]
#define DefaultHintTextFont [UIFont systemFontOfSize:55 weight:UIFontWeightBold]

#define DefaultHintTextColor UIColorFromRGB(0x424242)
